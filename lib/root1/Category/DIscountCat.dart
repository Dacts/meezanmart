                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            GestureDetector(
                              ...
                              child: Container(
                                height: 30.0,
                                child: new Text("No discount in this category .!",style: TextStyle(color: Colors.lightGreen,fontFamily: 'dacts',fontSize: 18.0),),
                              ),
                            ),
                          ],
                        ),
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              GestureDetector(
                                ...
                                child: Container(
                                  height: 30.0,
                                  child: new Text("Load More !", style: TextStyle(
